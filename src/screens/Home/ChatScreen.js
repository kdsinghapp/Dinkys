        ...
        <View style={{ flex: 1, backgroundColor: "#fff", padding: 20, paddingTop: 5 }}>
            ...
            <ScrollView >
                ...
                <View style={{ backgroundColor: "#FBFBFB", flexDirection: "row", alignItems: "center" }}>
                    <Pressable onPress={() => setShow("Products")} style={{
                        width: "48%", padding: 18,
                ...
                {show == "Products" ?
                    <View style={{ width: "100%", marginTop: 20 }}>
                        ...
                        {chatList?.length == 0 ? <View style={{ marginVertical: 20, justifyContent: 'center', alignItems: 'center' }}>

                            <Text style={{ fontWeight: '600', color: '#000', fontSize: 12 }}>{localizationStrings.no_data_here}</Text>
                        </View>
                            :
                    ...
                    <View style={{ width: "100%", flexDirection: "row", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", marginVertical: 20 }}>
                        ...
                        {chatList?.length == 0 && <View style={{ marginVertical: 20, 
                            width:'100%',
